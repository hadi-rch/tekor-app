...
const styles = StyleSheet.create({
    ...
    tabContainer: { flexDirection: 'row', justifyContent: 'space-around', borderBottomWidth: 1, borderBottomColor: COLORS.borderColor, backgroundColor: COLORS.white, },
    tab: { flex: 1, paddingVertical: 15, alignItems: 'center', borderBottomWidth: 2, borderBottomColor: 'transparent', },
    activeTab: { borderBottomColor: COLORS.primary, },
    tabText: { fontSize: fontPixel(16), color: COLORS.gray, },
    activeTabText: { color: COLORS.primary, fontWeight: 'bold', },
    listContainer: { paddingVertical: 10, paddingBottom: 60, },
    itemContainer: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 20, paddingVertical: 15, backgroundColor: COLORS.white, marginHorizontal: 15, borderRadius: 12, marginBottom: 12, elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.1, shadowRadius: 2, },
    itemDetails: { flex: 1, marginRight: 15, },
    itemStatus: { fontSize: fontPixel(12), fontWeight: 'bold', textTransform: 'uppercase', marginBottom: 4, },
    itemTitle: { fontSize: fontPixel(16), fontWeight: 'bold', color: COLORS.text, marginBottom: 4, },
    itemMeta: { fontSize: fontPixel(14), color: COLORS.gray, },
